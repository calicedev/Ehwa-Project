...
<body>
	...
	<header
		...
		<a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="/">세대 공감 Project</a>
						...
						<li class="mb-1">
							...
							<div class="collapse show" id="dashboard-collapse">
								<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
									...
									<li><a href="/board/list" class="link-dark rounded">공감공간</a></li>
									<li><a href="/board/theme" class="link-dark rounded">주제별
											모아보기</a></li>
								</ul>
							</div>
						</li>
							...
							<div class="collapse show" id="account-collapse">
								<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
									...
									<c:when test="${null == localStorage.getItem('time')}">
											...
											<li><a class="link-dark rounded" id="sessionstorage">${sessionStorage.getItem("email")}님</a></li>
										</c:when>

										<c:otherwise>
											<li><a class="link-dark rounded">${sessionScope.loginId}님</a></li>
											<li><a href="/board/friendadd" class="link-dark rounded">알림</a></li>
											<li><a href="/board/myanswer" class="link-dark rounded">나의 답변</a></li>
											<li>
